...
VOLUME /opt/tomcat/
ENV CATALINA_OPTS="-XX:+PrintFlagsFinal -XX:+PrintGCDetails  -Xms64m -Xmx256m  -XX:CompileThreshold=8000  -XX:+UseTLAB -XX:+ResizeTLAB -XX:ReservedCodeCacheSize=64m  -XX:+UseCodeCacheFlushing"
